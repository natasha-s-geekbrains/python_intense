...
if __name__ == '__main__':
    ...
    # student2 = Student("123 Иван", "subjects.csv")
    #
    # student3 = Student("Петров Петр", "subjects.csv")
    # student3.add_grade("Физика", 6)
    #
    # student4 = Student("Сидоров Сидор", "subjects.csv")
    # average_history_score = student4.get_average_test_score("Биология")
